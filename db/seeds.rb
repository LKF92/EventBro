...
10.times do
  User.create!(email: Faker::Name.first_name + "@yopmail.com", description: Faker::TvShows::BojackHorseman, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, password:"foobar" )
end
